...
会話を削除するのは `/delete`。とドキュメントには書いてあるが実在しない
...
- VS Code の GitHub Copilot は「GitHub アカウントでサインイン」する
- VS Code Copilot は OAuth 認証(ブラウザ経由)を必須とする
- VS Code Copilot は「環境変数によるトークン指定」をサポートしない
- VS Code Copilot が使うのは「VS Code の GitHub 認証基盤」

(参考) Copilot CLI は「環境変数・PAT」を使う
...
| 主張                                                 | 根拠URL                                                                                                     |
| ---------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| VS Code Copilot は GitHub アカウントでサインインする | <https://code.visualstudio.com/docs/copilot/setup>                                                          |
