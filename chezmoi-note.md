...
- [yadmでdotfilesを楽々管理](https://zenn.dev/stobita/articles/58c084c7cf7965)

Ubuntu ではパッケージになってた。 `sudo apt-get install yadm
`

GNU Stow

- [GNU Stowを使ってdotfiles管理を楽にする](https://zenn.dev/takatoshi335/articles/dotfiles-with-stow-setup)
