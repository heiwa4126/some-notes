...
- ブラウザが開く → Cloudflare にログイン
- CLI にトークン保存 (~/.config/.wrangler)
...
- GitHub 連携+Workers Builds にビルドさせる → build minutes 制限あり
