...
毎回どこだかわかんなくなるのでメモ。
だいたい title タグに表題が入ってないのがどうよ。

全部 PP サポートのアカウントが必要(公開情報にしてほしい... RHN みたいに途中まで見えるとか。そうすれば Google でインデクシングされるでしょ)。

- [[RHEL7]カーネルアップデート対応状況(x86_64)](https://www.support.nec.co.jp/View.aspx?NoClear=on&id=9010103842)
- [[RHEL7]仮想化環境(VMware)におけるゲスト OS のインストールについて](https://www.support.nec.co.jp/View.aspx?id=3140102828)
