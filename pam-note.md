...
- [6\.2\. pam_cracklib \- checks the password against dictionary words](http://www.linux-pam.org/Linux-PAM-html/sag-pam_cracklib.html)
...
[6\.37\. pam_unix \- traditional password authentication](http://www.linux-pam.org/Linux-PAM-html/sag-pam_unix.html)
...
このモジュールの使用例として、[pam_unix\(8\)](https://linux.die.net/man/8/pam_unix) のパスワードコンポーネントと組み合わせた場合を示します。
