...
- [対応言語](https://github.com/AlDanial/cloc?tab=readme-ov-file#Languages) 280 以上 (v1.90)

## インストール

参考: [Install via package manager](https://github.com/AlDanial/cloc?tab=readme-ov-file#install-via-package-manager)

歴史あるツールなので、Linux のディストリには標準でパッケージがある
...
npm パッケージまである。これはラッパーなので Perl が別途必要。

- [cloc - npm](https://www.npmjs.com/package/cloc?activeTab=readme)

※ Windows だったら [Strawberry Perl for Windows](https://strawberryperl.com/) がお勧め。

### Windows 版

Windows 版は Linux 版と比べて**異常に遅い**のでお勧めしない。

遅い理由は [Building a Windows Executable](https://github.com/AlDanial/cloc?tab=readme-ov-file#building-a-windows-executable-) 参照。

Windows で使うなら

- WSL に入れて `wsl cloc` (高速)
- または Perl と npm 版の組み合わせ (遅いがまあ我慢できる)
- [gocloc](https://github.com/hhatto/gocloc/) などの移植版を使う ([Other Counters](https://github.com/AlDanial/cloc?tab=readme-ov-file#other-counters-) 参照)
...
github.com/AlDanial/cloc v 1.90  T=5.86 s (698.4 files/s, 256613.0 lines/s)
-------------------------------------------------------------------------------
Language                     files          blank        comment           code
-------------------------------------------------------------------------------
Python                        3682         195093         250185         931534
CSV                             35              0              0          36792
C/C++ Header                   118           3973           9866          24560
Cython                          54           3831           4994          18607
C                               65           1288           1522           9852
XSLT                             9            619           1111           2515
SQL                              4              0              0           1398
...
reStructuredText                 4             64              1            265
Markdown                         5             58              0            171
C++                              1             13             14            143
Meson                            3             24              9            122
DOS Batch                        3             15              0            117
CSS                              1             24             10             70
Fish Shell                       1             20             34             70
TypeScript                       1              4             16             49
XSD                              1              0              3             47
...
Fortran 95                       1              0              1              4
-------------------------------------------------------------------------------
SUM:                          4092         205289         268130        1030146
-------------------------------------------------------------------------------
```

値が異常に大きいのは依存パッケージも含んでいるから。次章参照
...
他参考: [man cloc](https://manpages.ubuntu.com/manpages/noble/en/man1/cloc.1.html)
...
Usage: cloc [options] <file(s)/dir(s)/git hash(es)> | <set 1> <set 2> | <report files>
 ...
 Processing Options
   ...
   --config <file>           Read command line switches from <file> instead of
                             the default location of /home/heiwa/.config/cloc/options.txt.
                             ...
                             take priority over /home/heiwa/.config/cloc/options.txt.
